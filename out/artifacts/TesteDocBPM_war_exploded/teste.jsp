...
<html>
<head>
	<script src="http://localhost:8080/js/jquery-3.2.0.slim.min.js"></script>
	<script src="http://localhost:8080/bpmn.js/bpmn-navigated-viewer.js"></script>
	<link rel="stylesheet" type="text/css" href="http://localhost:8080/bpmn.js/assets/diagram-js.css" />
...
//				decorateTask(taskId, taskId, overlays);    
  ...
  function request() {
      ...
      xhttp.open("GET", "/ajax/processos", false);
      xhttp.send();
      var response = xhttp.responseText;
      if (response !== 'null') {
          var selector = '[data-element-id=' + response + ']';
          var element = document.querySelectorAll(selector)[0];
          element.style.fontWeight = 'bold';

          if (lastSelector !== "" && lastSelector !== selector) {
              var lastElement = document.querySelectorAll(lastSelector)[0];
